...
class RealsenseCamera:
    ...
    def connect_realsense(self, shape=(1920, 1080), fps=30):
    ...
    def take_pirture(self):
        if not hasattr(self, '__camera'):
            raise KeyError('Please connect realsense using connect_realsense() method')
...
def main():
    model_detection_path = 'yolov8n_e100.pt'
    model_classification_path = 'yolov8n_cls_v5_e100.pt'
